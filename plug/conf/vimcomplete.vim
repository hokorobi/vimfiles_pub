...
let s:options = #{
      ...
      \   enable: v:true,
      \   priority: 11,
      \   filetypes: ['go', 'markdown', 'plantuml', 'rst', 'vim'],
      \ },
      \ vimscript: #{
      \   enable: v:true,
      \   priority: 9,
...
" }}}
" autohotkey {{{
setlocal dictionary=~/vimfiles/plug/ddc/autohotkey.txt
" }}}
" plantuml {{{
setlocal dictionary=~/vimfiles/plug/ddc/plantuml.txt
" }}}
